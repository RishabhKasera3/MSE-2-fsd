    ...
    <aside className="filters">
      ...
      <div className="filter-group">
        ...
        <select className="sort-select" value={sortBy} onChange={e => onSortChange(e.target.value)}>
          ...
          <option value="price-asc">Price: Low to High</option> {/* BUG FIX 8: Changed price-desc to price-asc so "Low to High" sorts ascending */}
          <option value="price-desc">Price: High to Low</option> {/* BUG FIX 8: Changed price-asc to price-desc so "High to Low" sorts descending */}
